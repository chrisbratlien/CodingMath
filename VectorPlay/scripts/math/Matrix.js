define(['require', 'math/Vector'], function (require, Vector) {
...
transformVector: function(v) {
	...
	//Returns the matrix that when multiplied with matrix results in the identity matrix. You can optionally pass an existing matrix in result to avoid allocating a new matrix. This implementation is from the Mesa OpenGL function __gluInvertMatrixd() found in project.c.
	...
	//Returns matrix, exchanging columns for rows. You can optionally pass an existing matrix in result to avoid allocating a new matrix.
	...
	//Returns an orthographic projection, in which objects are the same size no matter how far away or nearby they are. You can optionally pass an existing matrix in result to avoid allocating a new matrix. This emulates the OpenGL function glOrtho().
